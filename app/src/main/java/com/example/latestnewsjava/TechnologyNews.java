 ...
 * Use the {@link TechnologyNews#newInstance} factory method to
...
public class TechnologyNews extends Fragment {
     ...
     * @return A new instance of fragment TechnologyNews.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        apiInterface.getDataTechnology(ApiKey).enqueue(new Callback<List<ModelClass>>() {
            @Override
